                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 sm:items-start group-hover:bg-slate-50 rounded-lg p-2 -ml-2 transition-colors">
                    ...
                    <div className="flex-1 space-y-1.5">
                      ...
                      {/* Booking Action */}
                      {activity.bookingId && activity.bookingType && (
                        <div className="mt-3">
                          <a
                            href={`/booking/${activity.bookingType}flow/${activity.bookingId}`}
                            className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-emerald-600 text-white text-xs font-semibold hover:bg-emerald-700 transition-colors shadow-sm"
                          >
                            <svg
                              className="w-3.5 h-3.5"
                              fill="none"
                            ...
                            Book This {activity.bookingType}
                          </a>
                        </div>
                      )}
                    </div>
